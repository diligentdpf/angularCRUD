...
function $RouteProvider(){
  ...
  this.when = function(path, route) {
    ...
    *
    * Inspired by pathRexp in visionmedia/express/lib/utils.angularjs.
    */
  ...
  this.$get = ['$rootScope',
     ...
     * @example
     ...
     <example module="ngViewExample" deps="angular-route.angularjs">
     ...
     * visionmedia/express/lib/router/router.angularjs.
     */
 ...
 * @example
    <example module="ngViewExample" deps="angular-route.angularjs" animations="true">
      <file name="index.html">
